// --- UTILS.JS - Funciones de ayuda (calcular hora, formatear fechas) ---

// Función para calcular la hora local de la ciudad buscada
export function calculateLocalTime(timezoneOffset) {
    ...
    // Retornamos un Objeto con dos cosas: el texto bonito y la hora numérica real
    return {
